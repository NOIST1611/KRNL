...
>  [View VFS Documentation here](/v0.2.0/documentation/VFS.md)
...
The following methods are implemented but **SHOULD NOT** be used by standard applications. Use the [VFS](/v0.2.0/documentation/VFS.md) instead.
